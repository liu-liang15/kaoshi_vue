          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="租客性别"   id="input_width">
                <el-input style="margin-left:13px;width: 240px;" v-model="csex"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="约看时间" prop="cage" id="inputt_width">
                <el-date-picker v-model="lookTime" style="margin-left:13px;width: 260px;" type="datetime"
                                placeholder="选择日期时间">
                </el-date-picker>
              </el-form-item>
            </el-col>
...
<style scoped="scoped">
/deep/  [data-v-230c5e99] .el-input--prefix .el-input__inner{
  width:240px;
}
.select_div {
  width: 200px;
